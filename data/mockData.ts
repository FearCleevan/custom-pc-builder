...
export const prebuiltSeries = {
  vision: {
    ...
    components: {
      ...
      motherboard:
        motherboardData.find((m) => m.specs.Chipset === "Z790")?.id || "mb-2",
      ram:
        ramData.find((r) => r.specs["Total Capacity"] === "64 GB")?.id ||
        "ram-2",
      storage:
        storageData.find((s) => s.specs.Capacity === "2000 GB")?.id ||
        "storage-1",
      psu:
        powerSupplyData.find((p) => p.specs.Wattage === "1000")?.id || "psu-1",
      case: caseData[0]?.id || "case-1",
      cooler:
        cpuCoolerData.find((c) => c.specs["Radiator Size"] === "360 mm")?.id ||
        "cooler-1",
    },
  },
  infinite: {
    ...
    components: {
      ...
      gpu: gpuData.find((g) => g.name.includes("RTX 4090"))?.id || "gpu-1",
      motherboard:
        motherboardData.find((m) => m.specs.Chipset === "X670E")?.id || "mb-1",
      ram:
        ramData.find((r) => r.specs["Total Capacity"] === "128 GB")?.id ||
        "ram-4",
      storage:
        storageData.find((s) => s.specs.Capacity === "2000 GB")?.id ||
        "storage-1",
      psu:
        powerSupplyData.find((p) => p.specs.Wattage === "1300")?.id || "psu-2",
      case: caseData[0]?.id || "case-1",
      cooler:
        cpuCoolerData.find((c) => c.specs["Radiator Size"] === "360 mm")?.id ||
        "cooler-1",
  ...
  aegis: {
    ...
    components: {
      cpu: cpuData.find((c) => c.name.includes("14700K"))?.id || "cpu-4",
      gpu: gpuData.find((g) => g.name.includes("RTX 4080"))?.id || "gpu-3",
      motherboard:
        motherboardData.find((m) => m.specs.Chipset === "Z790")?.id || "mb-2",
      ram:
        ramData.find((r) => r.specs["Total Capacity"] === "32 GB")?.id ||
        "ram-1",
      storage:
        storageData.find((s) => s.specs.Capacity === "1000 GB")?.id ||
        "storage-2",
      psu:
        powerSupplyData.find((p) => p.specs.Wattage === "850")?.id || "psu-3",
      case:
        caseData.find((c) => c.specs["Form Factor"] === "ATX Mid Tower")?.id ||
        "case-3",
      cooler:
        cpuCoolerData.find((c) => c.specs["Radiator Size"] === "240 mm")?.id ||
        "cooler-5",
    },
  },
  codex: {
    ...
    components: {
      ...
      ram:
        ...
        "ram-4",
      storage:
        storageData.find((s) => s.specs.Capacity === "4000 GB")?.id ||
        "storage-3",
      psu:
        powerSupplyData.find((p) => p.specs.Wattage === "1300")?.id || "psu-2",
      case: caseData[0]?.id || "case-1",
  ...
  industrial: {
    ...
    components: {
      ...
      ram:
        ...
        "ram-4",
      storage:
        storageData.find((s) => s.specs.Capacity === "8000 GB")?.id ||
        "storage-4",
      psu:
        powerSupplyData.find((p) => p.specs.Wattage === "1600")?.id || "psu-5",
      case: caseData[0]?.id || "case-1",
      cooler:
        cpuCoolerData.find((c) => c.specs["Radiator Size"] === "480 mm")?.id ||
        "cooler-1",
    },
  },
};
